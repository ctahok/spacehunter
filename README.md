...
- **Aim:** Mouse cursor
- **Fire:** Left mouse click (hold for auto-fire)
...
- **Player:** Bright cyan spacecraft with motion trail
...
2. **Small = Deadly:** Small asteroids are worth more points but harder to hit
3. **Combo Kills:** Destroy asteroids within 2 seconds of each other for a 1.5x score multiplier
4. **Weapon Timing:** Weapons expire after 20 seconds—use them wisely!
5. **Invulnerability:** After taking damage, you have 1 second of invulnerability (red flash)
